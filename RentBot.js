...
auth: state,
browser: [`Yonz Bot By ${ownername}`, "Chrome", "1.0.0"],
...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '62895613103580@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6285731589675@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `62895613103580@s.whatsapp.net`
}
}, options)
